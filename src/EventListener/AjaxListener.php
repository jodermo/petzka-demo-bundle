...
use Petzka\DemoBundle\Widget\ArticleCategoriesPickerWidget;
...
class AjaxListener implements FrameworkAwareInterface
{
    ...
    {
        if ('reloadArticleCategoriesWidget' === $action) {
            $this->reloadArticleCategoriesWidget($dc);
        }
    }

    /**
     * Reload the article categories widget.
     *
     * @param DataContainer $dc
     */
    private function reloadArticleCategoriesWidget(DataContainer $dc)
    {
        /**
         * @var Database
         * @var Input    $input
        ...
        /** @var ArticleCategoriesPickerWidget $strClass */
        $strClass = $GLOBALS['BE_FFL']['articleCategoriesPicker'];

        /** @var ArticleCategoriesPickerWidget $objWidget */
